...
void CScriptGameObject::SetTorchBatteryStatus(u16 value)
{
    ...
    {
        GEnv.ScriptEngine->script_log(LuaMessageType::Error, "This method works only for torch, check your code!");
        return;
    }
}
...
void CScriptGameObject::SetTorchState(bool state)
{
    ...
    if (actor)
    {
        ...
        if (!flashlight)
        {
            GEnv.ScriptEngine->script_log(LuaMessageType::Error, "Actor flashlight does not exist!");
            return;
        }
    ...
    {
        GEnv.ScriptEngine->script_log(LuaMessageType::Error, "This method works only for actor, check your code!");
        return;
    }
}
