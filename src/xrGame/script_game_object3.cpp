...
//float CScriptGameObject::GetArtefactKurrRestoreSpeed()
//{
//	CArtefact* artefact = smart_cast<CArtefact*>(&object());
//	THROW(artefact);
//
//	return artefact->GetKurrPower();
//}

//void CScriptGameObject::SetArtefactKurrRestoreSpeed(float value)
//{
//    CArtefact* artefact = smart_cast<CArtefact*>(&object());
//    THROW(artefact);
//
//    artefact->SetKurrPower(value);
//}
