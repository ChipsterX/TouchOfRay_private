...
#define CStateBloodsuckcsVampireExecuteAbstract CStateBloodsuckcsVampireExecute<_Object>
...
void CStateBloodsuckcsVampireExecuteAbstract::initialize()
{
...
TEMPLATE_SPECIALIZATION
void CStateBloodsuckcsVampireExecuteAbstract::execute()
{
...
TEMPLATE_SPECIALIZATION
void CStateBloodsuckcsVampireExecuteAbstract::finalize()
{
	inherited::finalize();
...
TEMPLATE_SPECIALIZATION
void CStateBloodsuckcsVampireExecuteAbstract::critical_finalize()
{
...
TEMPLATE_SPECIALIZATION
bool CStateBloodsuckcsVampireExecuteAbstract::check_start_conditions()
{
...
TEMPLATE_SPECIALIZATION
bool CStateBloodsuckcsVampireExecuteAbstract::check_completion()
{
...
TEMPLATE_SPECIALIZATION
void CStateBloodsuckcsVampireExecuteAbstract::execute_vampire_prepare()
{
	object->com_man().ta_activate		(object->anim_triple_vampire);
	time_vampire_started				= Device.dwTimeGlobal;
	
	object->sound().play(CAI_Bloodsuckcs::eVampireGrasp);
}

TEMPLATE_SPECIALIZATION
void CStateBloodsuckcsVampireExecuteAbstract::execute_vampire_continue()
{
	...
	object->sound().play(CAI_Bloodsuckcs::eVampireSucking);
...
TEMPLATE_SPECIALIZATION
void CStateBloodsuckcsVampireExecuteAbstract::execute_vampire_hit()
{
	object->com_man().ta_pointbreak				();
	object->sound().play						(CAI_Bloodsuckcs::eVampireHit);
...
TEMPLATE_SPECIALIZATION
void CStateBloodsuckcsVampireExecuteAbstract::look_head()
{
...
#undef CStateBloodsuckcsVampireExecuteAbstract
