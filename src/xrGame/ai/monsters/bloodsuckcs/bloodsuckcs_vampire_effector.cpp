...
CVampirePPEffectcs::CVampirePPEffectcs(const SPPInfo &ppi, float life_time) :
...
BOOL CVampirePPEffectcs::Process(SPPInfo& pp)
{
...
CVampireCameraEffectcs::CVampireCameraEffectcs(float time, const Fvector &src, const Fvector &tgt) :
...
BOOL CVampireCameraEffectcs::ProcessCam(SCamEffectorInfo& info)
{
