...
#define CStateBloodsuckcsVampireHideAbstract CStateBloodsuckcsVampireHide<_Object>

TEMPLATE_SPECIALIZATION
CStateBloodsuckcsVampireHideAbstract::CStateBloodsuckcsVampireHide(_Object *obj) : inherited(obj)
{
	add_state	(eStateVampire_RunAway,		xr_new CStateMonsterHideFromPoint<_Object> 	(obj));
	add_state	(eStatePredator,			xr_new CStateBloodsuckcsPredator<_Object> 		(obj));
}

TEMPLATE_SPECIALIZATION
void CStateBloodsuckcsVampireHideAbstract::reselect_state()
{
...
TEMPLATE_SPECIALIZATION
void CStateBloodsuckcsVampireHideAbstract::setup_substates()
{
...
TEMPLATE_SPECIALIZATION
bool CStateBloodsuckcsVampireHideAbstract::check_completion()
{
...
#undef CStateBloodsuckcsVampireHideAbstract
