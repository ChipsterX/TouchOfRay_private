...
enum EMonsterState
{
	...
	eStateBurcsScanning = eStateCustom | 2,
    eStateCustomMoveToRestrictor = eStateCustom | 3,

    eStateSmartTerrainTask = eStateCustom | 4,
    eStateSmartTerrainTaskGamePathWalk = eStateCustom | 5,
    eStateSmartTerrainTaskLevelPathWalk = eStateCustom | 6,
    eStateSmartTerrainTaskWaitCapture = eStateCustom | 7,
	...
	eStateBurcsAttack_Tele = eStateCustom | eStateAttack | 17,
    eStateBurcsAttack_Gravi = eStateCustom | eStateAttack | 18,
    eStateBurcsAttack_RunAround = eStateCustom | eStateAttack | 19,
    eStateBurcsAttack_FaceEnemy = eStateCustom | eStateAttack | 20,
    eStateBurcsAttack_Melee = eStateCustom | eStateAttack | 21,
