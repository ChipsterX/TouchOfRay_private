...
xr_string make_xrstr(EMonsterState state) noexcept
{
	...
	case eStateBurcsScanning: return "BurcsScanning";
	...
	case eStateBurcsAttack_FaceEnemy: return "BurcsAttack_FaceEnemy";
	case eStateBurcsAttack_Gravi: return "BurcsAttack_Gravi";
	case eStateBurcsAttack_Melee: return "BurcsAttack_Melee";
	case eStateBurcsAttack_RunAround: return "BurcsAttack_RunAround";
	case eStateBurcsAttack_Tele: return "BurcsAttack_Tele";
