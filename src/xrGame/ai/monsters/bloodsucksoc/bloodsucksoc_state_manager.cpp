...
{
	add_state(eStateRest, new CStateMonsterRest<CAI_Bloodsucksoc>(monster));
	add_state(eStatePanic, new CStateMonsterPanic<CAI_Bloodsucksoc>(monster));
	add_state(eStateAttack, new CBloodsucksocStateAttack<CAI_Bloodsucksoc>(monster));
	add_state(eStateEat, new CStateMonsterEat<CAI_Bloodsucksoc>(monster));
	add_state(eStateHearInterestingSound, new CStateMonsterHearInterestingSound<CAI_Bloodsucksoc>(monster));
	add_state(eStateHitted, new CStateMonsterHitted<CAI_Bloodsucksoc>(monster));
	add_state(eStateVampire_Execute, new CStateBloodsucksocVampireExecute<CAI_Bloodsucksoc>(monster));
}
