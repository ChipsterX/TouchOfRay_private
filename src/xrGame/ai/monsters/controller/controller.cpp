...
void CController::Load(LPCSTR section)
{
	...
	GEnv.Sound->create(control_start_sound, pSettings->r_string(section, "sound_control_start"), st_Effect, SOUND_TYPE_WORLD);
...
void CController::Die(IGObj* who)
{
	inherited::Die(who);
	FreeFromControl();
...
void CController::net_Relcase(IGObj *O)
{
