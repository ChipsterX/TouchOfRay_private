...
void CUIZoneMap::Init()
{
	...
	if (type_hud_token == 2)
        uiXml.Load(CONFIG_PATH, UI_PATH, UI_PATH_DEFAULT, ZONE_MAP_XML_CMP);

	if (type_hud_token == 3)
        uiXml.Load(CONFIG_PATH, UI_PATH, UI_PATH_DEFAULT, ZONE_MAP_XML_STS);

	if (type_hud_token == 8)
        uiXml.Load(CONFIG_PATH, UI_PATH, UI_PATH_DEFAULT, ZONE_MAP_XML_MIS);
    ...
    if (type_hud_token == 6 || type_hud_token == 5 || type_hud_token == 7 || type_hud_token == 4 || type_hud_token == 9)
    {
		...
		if (type_hud_token == 4)
            uiXml.Load(CONFIG_PATH, UI_PATH, UI_PATH_DEFAULT, ZONE_MAP_XML_CS);
		...
		if (type_hud_token == 9)
            uiXml.Load(CONFIG_PATH, UI_PATH, UI_PATH_DEFAULT, ZONE_MAP_XML_PCH);
