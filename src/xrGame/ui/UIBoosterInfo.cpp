...
void CUIBoosterInfo::InitFromXml(CUIXml& xml)
{
	...
	m_booster_sleep = new UIBoosterInfoItem();
	m_booster_sleep->Init(xml, "boost_sleep");
	m_booster_sleep->SetAutoDelete(false);
	name = StringTable().translate("ui_inv_sleep").c_str();
	...
	m_booster_kurr = new UIBoosterInfoItem();
	m_booster_kurr->Init(xml, "boost_kurr");
	m_booster_kurr->SetAutoDelete(false);
	name = StringTable().translate("ui_inv_kurr").c_str();
	...
	m_booster_komponent = new UIBoosterInfoItem();
