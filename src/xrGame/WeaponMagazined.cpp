...
void CWeaponMagazined::switch2_Reload()
{
    CWeapon::FireEnd();
#ifndef DISABLE_STCOP_3_3
	bool bEmptyEnable = m_ammoElapsed.type1 > 0 && isHUDAnimationExist("anm_reload_empty") && !m_bGrenadeMode && m_reload_from_stcop3_3;
...
void CWeaponMagazined::GetBriefInfo_ammo(xr_string& str_name, xr_string& icon_sect_name, xr_string& str_count, string16& fire_mode)
{
    ...
    string256 sItemName;
    strcpy_s(sItemName, *StringTable().translate(pSettings->r_string(icon_sect_name.c_str(), "inv_name_short")));
