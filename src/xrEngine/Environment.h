...
public:
	...
	float m_fEffecrDrops;
//	float m_fEffecrVignette;
...
protected:
	...
	float actorHudWetnessRSeed_1_; // random for random position of drops layer 1
	float actorHudWetness_2_; // for storing actors wetness on hud layer 2
	float actorHudWetnessRSeed_2_; // random for random position of drops layer 
...
public:
	...
	//Wetness on hud for rain drops count calculation in shader
	void					SetActorHudWetness2	(float val)			{ actorHudWetness_2_ = val; };
	//Wetness on hud for rain drops count calculation in shader
	IC float				GetActorHudWetness2	()					{ return actorHudWetness_2_; };

	//Randomness of drops position
	void					SetActorHudWetnessRand1	(float val)		{ actorHudWetnessRSeed_1_ = val; };
	//Randomness of drops position
	IC float				GetActorHudWetnessRand1	()				{ return actorHudWetnessRSeed_1_; };

	//Randomness of drops position
	void					SetActorHudWetnessRand2	(float val)		{ actorHudWetnessRSeed_2_ = val; };
	//Randomness of drops position
	IC float				GetActorHudWetnessRand2	()				{ return actorHudWetnessRSeed_2_; };
