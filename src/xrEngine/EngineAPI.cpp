...
constexpr pcstr R2_LIBRARY 		= "renders\\xrRender_DX9";
constexpr pcstr R3_LIBRARY 		= "renders\\xrRender_DX10";
constexpr pcstr R4_LIBRARY 		= "renders\\xrRender_DX11";

constexpr pcstr RENDERER_R2A	= "Renderer_DX9_1";
constexpr pcstr RENDERER_R2 	= "Renderer_DX9_2";
constexpr pcstr RENDERER_R2_5 	= "Renderer_DX9_3";
constexpr pcstr RENDERER_R3 	= "Renderer_DX10";
constexpr pcstr RENDERER_R4 	= "Renderer_DX11";
...
void CEngineAPI::Initialize(void)
{
    ...
    hGame = XRay::LoadModule("game\\xrGame");
...
void CEngineAPI::CreateRendererList()
{
    ...
    Msg("The available modes for the engine 5:");
