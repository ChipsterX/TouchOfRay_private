...
CEnvironment::CEnvironment() : CurrentEnv(0), m_ambients_config(0)
{
    ...
    m_ambients_config =
        new CInifile(FS.update_path(file_name, "$game_config$", "mystical_weather\\ambients_af3.ltx"), TRUE, TRUE, FALSE);
    m_sound_channels_config =
        new CInifile(FS.update_path(file_name, "$game_config$", "mystical_weather\\ambients_mw_sound_channels.ltx"), TRUE, TRUE, FALSE);
    m_effects_config =
        new CInifile(FS.update_path(file_name, "$game_config$", "mystical_weather\\ambients_af3_effects.ltx"), TRUE, TRUE, FALSE);
    m_suns_config =
        new CInifile(FS.update_path(file_name, "$game_config$", "mystical_weather\\flares_af3_suns.ltx"), TRUE, TRUE, FALSE);
    m_thunderbolt_collections_config = new CInifile(
        FS.update_path(file_name, "$game_config$", "mystical_weather\\ambietns_af3_thunderbolt_collections.ltx"), TRUE, TRUE, FALSE);
    m_thunderbolts_config =
        new CInifile(FS.update_path(file_name, "$game_config$", "mystical_weather\\ambients_af3_thunderbolts.ltx"), TRUE, TRUE, FALSE);

    CInifile* config =
        new CInifile(FS.update_path(file_name, "$game_config$", "mystical_weather\\af3_environment.ltx"), TRUE, TRUE, FALSE);
    // params
	...
	actorHudWetnessRSeed_1_ = 0.1f;

	actorHudWetness_2_		= 0.f;
	actorHudWetnessRSeed_2_ = 0.05f;
