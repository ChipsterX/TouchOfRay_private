...
void CRenderTarget::phase_scene_prepare()
{
	...
	else
	{
		...
		HW.pDevice->ClearRenderTargetView(rt_Extension->pRT, ColorRGBA);
...
void CRenderTarget::phase_scene_begin()
{
	...
	if (RImplementation.o.albedo_wo)
		u_setrt(rt_Position, rt_Accumulator, rt_Extension, pZB);
	else
		u_setrt(rt_Position, rt_Color, rt_Extension, pZB);
