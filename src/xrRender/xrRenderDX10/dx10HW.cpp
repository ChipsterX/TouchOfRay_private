...
void CHW::CreateDevice(HWND m_hWnd, bool move_window)
{
    ...
    sd.BufferCount = ps_r3_backbuffers_count;
...
DXGI_RATIONAL CHW::selectRefresh(u32 dwWidth, u32 dwHeight, DXGI_FORMAT fmt)
{
    ...
    */
    ...
    else if (ps_mHToken == 1)
        res = { 59, 0 };

    else if (ps_mHToken == 2)
        res = { 60, 1 };

    else if (ps_mHToken == 3)
        res = { 74, 1 };

    else if (ps_mHToken == 4)
        res = { 75, 0 };

    else if (ps_mHToken == 5)
        res = { 90, 1 };

    else if (ps_mHToken == 6)
        res = { 100, 1 };

    else if (ps_mHToken == 7)
        res = { 120, 1 };

    else if (ps_mHToken == 8)
        res = { 144, 1 };

    else if (ps_mHToken == 9)
        res = { 165, 0 }; 

    else if (ps_mHToken == 10)
        res = { 240, 1 };

    else if (ps_mHToken == 11)
        res = { 244, 1 };
