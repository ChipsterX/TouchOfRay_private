...
void CBlender_BmmD::Compile(CBlender_Compile& C)
{
    ...
    case SE_R2_NORMAL_HQ: // deffer
		...
		C.r_Sampler("s_puddles", "bttr_shaders\\puddles_mask", false,	D3DTADDRESS_WRAP, D3DTEXF_ANISOTROPIC,D3DTEXF_LINEAR, D3DTEXF_ANISOTROPIC);
...
void CBlender_BmmD::Compile(CBlender_Compile& C)
{
    ...
    case SE_R2_NORMAL_HQ: // deffer
		...
		C.r_dx10Texture("s_puddles", "bttr_shaders\\puddles_mask");
