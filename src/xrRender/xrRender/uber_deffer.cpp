...
// Uber-construct
    ...
    if (C.L_textures.size() >= 0 && (RImplementation.Resources->m_textures_description.TessMethod(C.L_textures[0].c_str()) != 32))
    {
        C.TessMethod = RImplementation.Resources->m_textures_description.TessMethod(C.L_textures[0].c_str());
