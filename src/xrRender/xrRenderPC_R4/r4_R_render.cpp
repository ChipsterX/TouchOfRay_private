...
#include "xrRender/xrRender/QueryHelper.h"
...
void CRender::Render()
{
    ...
    Fcolor sunColor = ((light*)Lights.sun._get())->color;
    BOOL bSUN = ps_r2_ls_flags.test(R2FLAG_SUN) && (u_diffuse2s(sunColor.r, sunColor.g, sunColor.b) > EPS);
