...
static class cl_vignette_param : public R_constant_setup
{
    virtual void setup(R_constant* C)
    {
        RCache.set_c(C, ps_r2_vignette, 0, 0, 0);
    }
}	binder_vignette;
...
extern float debug_f_h;
extern float debug_f_d;
extern float debug_f_maxd;
extern float debug_f_mixd;
...
void CRender::create()
{
	...
	Resources->RegisterConstantSetup("vignette", &binder_vignette);
	Resources->RegisterConstantSetup("volumetric_fog", &binder_volumetric_fog);
    Resources->RegisterConstantSetup("water_intensity", &binder_water_intensity);
	Resources->RegisterConstantSetup("fog_shaders_values", &binder_fog_shaders);
    Resources->RegisterConstantSetup("steep_parallax", &binder_steep_parallax);
	Resources->RegisterConstantSetup("various_consts_2", &binder_other_consts_2);
