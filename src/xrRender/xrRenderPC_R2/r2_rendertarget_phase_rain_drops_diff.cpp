...
void CRenderTarget::phase_rain_drops_diff()
{
		u32 Offset = 0;
		Fvector2 p0, p1;
		...
		float fValue = env.m_fEffecrDrops;

		RCache.set_Element(s_rain_drops_diff->E[0]);
		RCache.set_c("rain_drops_params0_diff", fValue, ps_r2_rain_drops_diff, 0, 0);
