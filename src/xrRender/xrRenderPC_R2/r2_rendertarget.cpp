...
void CRenderTarget::u_setrt(
    u32 W, u32 H, IDirect3DSurface9* _1, IDirect3DSurface9* _2, IDirect3DSurface9* _3, IDirect3DSurface9* _4, IDirect3DSurface9* zb)
{
    VERIFY(_1);
    dwWidth = W;
    dwHeight = H;
...
CRenderTarget::CRenderTarget()
{
    ...
    //  NORMAL
    {
        ...
        rt_Extension.create(r2_RT_E, w, h, D3DFMT_A8R8G8B8);
