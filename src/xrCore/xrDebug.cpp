...
//--' Создать мини-дамп, вместо окна лога
...
int out_of_memory_handler(size_t size)
{
    ...
    else
    {
        ...
        Msg("* [Touch of ray 4.3]: process heap[%zu K]", processHeap / 1024);
        Msg("* [Touch of ray 4.3]: economy: strings[%zu K], smem[%zu K]", ecoStrings / 1024, ecoSmem);
    }
