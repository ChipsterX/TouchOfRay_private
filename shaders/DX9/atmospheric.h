...
float3 compute_stars(float3 img, float3 dir)
{
    ...
    float s_layer_1 = tex2D(s_stars, dir.xz*1024.f).r;
    float s_layer_2 = tex2D(s_stars, dir.xz*1024.f).g;
    float s_layer_3 = tex2D(s_stars, dir.xz*1024.f).b;
    float s_layer_4 = tex2D(s_stars, dir.xz*1024.f).a;
